...
if os.path.exists('/src/Config/'+MIDI_CONF):
	usingMIDI = True
	
	#get MIDI command configuration from file
	midi_commands_file = open('/src/Config/'+MIDI_CONF, 'r')
...
if os.path.exists('/src/Config/'+CHANNELS_CONF):
	#get channel to track binding from file
	channel_to_tracks_file = open('/src/Config/'+CHANNELS_CONF, 'r')
...
if os.path.exists('/src/Config/'+GUI_CONF):
	#get track names from file
	track_names_file = open('/src/Config/'+GUI_CONF, 'r')
